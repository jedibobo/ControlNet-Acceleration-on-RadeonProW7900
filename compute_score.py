...
from canny2image import amdpervasivecontest
...
scores = []
latencys = []
acc = amdpervasivecontest()
acc.initialize()

for i in range(20):
    path = "/home/lyb/code/ControlNet/pictures_croped/bird_"+ str(i) + ".jpg"
    img = cv2.imread(path)
    start = datetime.datetime.now().timestamp()
    new_img = acc.process(img,
            "a bird", 
    ...
    new_path = "./generated_imgs/bird_"+ str(i) + ".jpg"
